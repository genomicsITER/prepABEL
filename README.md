# prepABEL
A simple script combining BASH line commands to grab data from dosage VCF files generated by Michigan Imputation Server and prepare input files to run survival analyses with _ProbABEL_, a software to do survival analysis relying upon imputed genotyped dosage data. prepABEL prepares the following _ProbABEL_ input files:
